-- TDX Macro Runner - Rebuild (Fixed & Loadstring-Compatible + Priority + Strict Success)
...
local function getPriority(towerName)
    return typePriority[towerName] or typePriority.default
end
