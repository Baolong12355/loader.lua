...
FirstPersonHandler.Begin = function(towerInstance)
    if pcall(shouldStopFPS) and shouldStopFPS() then
        return
    end
...
RunService.Heartbeat:Connect(function()
    local shouldStop = pcall(shouldStopFPS) and shouldStopFPS()
    if shouldStop and controlledTower then
        pcall(function() FirstPersonHandler.Stop() end)
        return
    end
